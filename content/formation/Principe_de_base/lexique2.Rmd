...
library(leaflet.extras2)
 leaflet()%>%
    ...
    addMapPane("right", zIndex = 0)%>%addProviderTiles(providers$Esri.WorldImagery,layerId = "l",
                                                       options = pathOptions(pane = "left"))%>%addProviderTiles(providers$OpenStreetMap.Mapnik,
                                                                                                                options = pathOptions(pane = "right"),layerId = "r",) %>%    addSidebyside(layerId = "sidecontrols",
                                                                                                                                                                                           rightId = "r",
                                                                                                                                                                                           leftId = "l")%>%setView(-73.397111,45.178539, zoom = 17)   
```
